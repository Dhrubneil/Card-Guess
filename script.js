    ...
    if(betAmount && betAmount <= currentAmount){
        ...
        setTimeout(() => {
            ...
            cards.forEach((card) => {
                ...
                card.style.background = 'rgb(37, 37, 37)';
            })
...
cardTags.forEach((card, index) => {
    card.addEventListener('click', () => {
        ...
        let currentDisplayedAmount = currentAmount;
        ...
        if(cardsActive){
            ...
            if(cards[index] == 'queen'){
                var myInterval = setInterval(() => {
                    document.getElementById('current-amount').innerHTML = `$${currentDisplayedAmount}`;
                    currentDisplayedAmount += 1;
                    if(currentDisplayedAmount > currentAmount){
